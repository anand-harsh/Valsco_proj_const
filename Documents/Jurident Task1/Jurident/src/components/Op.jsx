      ...
      <div className="op-main">
        <div className="section">
          ...
          <div className="op-content">
            <h1 className="project-title">01/PROJECT NAME</h1>
            ...
            <a href="#" className="project-link">More shots from this project</a>
          </div>
        </div>
        <div className="section">
          <div className="image">
          ...
          <div className="op-content">
            <h1 className="project-title">02/PROJECT NAME</h1>
            <p className="project-description">
        ...
        <div className="section">
          ...
          <div className="op-content">
            <h1 className="project-title">03/PROJECT NAME</h1>
            <p className="project-description">
